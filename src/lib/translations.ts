...
export const translations = {
  hi: {
    ...
    slopePercent: 'ढलान (%)',
    roofRatio: 'छत अनुपात',
    creatorTitle: 'आदिश द्वारा निर्मित',
    creatorBadge: 'CREATOR',
    creatorSubtitle: 'प्रेम से, आपके आध्यात्मिक संरेखण के लिए',
    creatorFooter: 'Made with ❤️ for Spiritual Alignment',
    vialHorizontal: 'क्षैतिज वायल (रोल)',
    vialVertical: 'ऊर्ध्वाधर वायल (पिच)',
    levelHold: 'माप रोकें',
    levelHoldHint: 'वर्तमान रीडिंग फ्रीज़ करने के लिए टैप करें',
    levelAngleMode: 'कोण मोड',
    angleRelative: 'सापेक्ष',
    angleAbsolute: 'निरपेक्ष',
    soundOnLevel: 'स्तर पर ध्वनि',
    referenceLock: 'संदर्भ लॉक',
    referenceLockHint: 'वर्तमान को 0° के रूप में सेट करें',
    calibrate: 'कैलिब्रेट',
    maxTilt: 'अधिकतम झुकाव',
    minTilt: 'न्यूनतम झुकाव',
    stability: 'स्थिरता',
    copyReading: 'रीडिंग कॉपी करें',
    readingCopied: 'रीडिंग कॉपी हो गई!',
    tiltLeft: 'बाएं झुकाएं',
    tiltRight: 'दाएं झुकाएं',
    tiltForward: 'आगे झुकाएं',
    tiltBack: 'पीछे झुकाएं',
    levelAchieved: 'स्तर प्राप्त!',
    resetMaxMin: 'रीसेट',
    holdToMeasure: 'मापने के लिए दबाए रखें',
  ...
  en: {
    ...
    creatorTitle: 'CREATED BY AADISH',
    creatorBadge: 'CREATOR',
    creatorSubtitle: 'with love, for your spiritual alignment',
    creatorFooter: 'Made with ❤️ for Spiritual Alignment',
    vialHorizontal: 'HORIZONTAL VIAL (ROLL)',
    vialVertical: 'VERTICAL VIAL (PITCH)',
    levelHold: 'HOLD',
    levelHoldHint: 'Tap to freeze current reading',
    levelAngleMode: 'ANGLE MODE',
    angleRelative: 'RELATIVE',
    angleAbsolute: 'ABSOLUTE',
    soundOnLevel: 'SOUND ON LEVEL',
    referenceLock: 'REF LOCK',
    referenceLockHint: 'Set current as 0°',
    calibrate: 'CALIBRATE',
    maxTilt: 'MAX TILT',
    minTilt: 'MIN TILT',
    stability: 'STABILITY',
